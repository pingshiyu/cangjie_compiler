...
/**
 * A ResumptionTypePattern node represents the resumption type pattern.
 */
struct ResumptionTypePattern : Pattern {
    OwnedPtr<Pattern> pattern;            /**< VarPattern. Generated by Parser*/
    Position patternPos;                  /**< Position of VarPattern. Generated by Parser*/
    Position colonPos;                    /**< Position of ':'. Generated by Parser*/
    std::vector<OwnedPtr<Type>> types;    /**< Types of Resumptions. Generated by Parser*/
    std::vector<Position> bitOrPosVector; /**< Positions of '|'. Generated by Parser*/
    ResumptionTypePattern() : Pattern(ASTKind::RESUMPTION_TYPE_PATTERN)
    {
    }
};
...
struct Handler {
    ...
    OwnedPtr<Pattern> resumptionPattern;
...
struct TryExpr : Expr {
    ...
    /**
     * Is any of the handlers in this try expression a deferred handler.
     */
    bool HasDeferredHandlers()
    {
        for (auto& h : handlers) {
            if (!h.IsImmediate()) {
                return true;
...
struct ResumeExpr : Expr {
    ...
    OwnedPtr<Expr> expr;                   /**< Resume expr. */
